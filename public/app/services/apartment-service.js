...
var ApartmentService = (function () {
    ...
    ApartmentService.prototype.create = function (apartment, user) {
        return this.http.post('/api/apartments', { apartment: apartment, user: user }, this.jwt()).map(function (response) { return response.json(); });
    };
